...
{
    private readonly ILogger<TransactionBehavior<TRequest, TResponse>> _logger = logger ?? throw new ArgumentException(nameof(logger));
    private readonly OrderingContext _dbContext = dbContext ?? throw new ArgumentException(nameof(dbContext));
